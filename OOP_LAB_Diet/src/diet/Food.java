...
public class Food {
	...
	public SortedMap<String, NutritionalElement> products = new TreeMap<>();
	public SortedMap<String, NutritionalElement> recipes = new TreeMap<>();
	public SortedMap<String, NutritionalElement> menus = new TreeMap<>();
	/**
	...
	public void defineRawMaterial(String name, double calories, double proteins, double carbs, double fat){
		this.rawMaterials.put(name, new RawMaterial(name, calories, proteins, carbs, fat));
	}
	...
	public void defineProduct(String name, double calories, double proteins, double carbs, double fat){
		this.products.put(name, new Product(name, calories, proteins, carbs,fat));
	}
